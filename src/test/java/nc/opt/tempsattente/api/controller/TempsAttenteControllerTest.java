...
public class TempsAttenteControllerTest {
    ...
    public void testRedirect() throws Exception {
        ...
        MvcResult result = (MvcResult) mvc.perform(MockMvcRequestBuilders.get("/").accept(MediaType.APPLICATION_JSON))
            .andDo(print())
    ...
    public void testGetAgences_0args() throws Exception {
        ...
        MvcResult result = (MvcResult) mvc
            .perform(MockMvcRequestBuilders.get("/temps-attente/agences").accept(MediaType.APPLICATION_JSON))
            .andDo(print())
            .andExpect(status().isOk())
            .andReturn();

        ArrayList<Agence> listeAgence = mapper.readValue(result.getResponse().getContentAsString(),
    ...
    @Test
    public void testGetAgencesByDistance_0args() throws Exception {

        String result = mvc
            .perform(MockMvcRequestBuilders
                .get("/temps-attente/agences?lon=166.4260482788086&lat=-22.25097078275085&distanceInMeters=3000")
        ...
        ArrayList<Agence> listeAgence = mapper.readValue(result, new TypeReference<ArrayList<Agence>>() {
        });

        assertEquals(5, listeAgence.size());
    }
    ...
    public void testGetAgencesGood_String() throws Exception {
        ...
        MvcResult result = (MvcResult) mvc
            .perform(MockMvcRequestBuilders.get("/temps-attente/agences/{communeName}", "moindou")
                .accept(MediaType.APPLICATION_JSON))
            .andDo(print())
            .andExpect(status().isOk())
            .andReturn();
    ...
    public void testGetAgencesBad_String() throws Exception {
        ...
        MvcResult result = (MvcResult) mvc
            .perform(MockMvcRequestBuilders.get("/temps-attente/agences/{communeName}", "toto")
                .accept(MediaType.APPLICATION_JSON))
            .andDo(print())
    ...
    public void testGetCommunesNames() throws Exception {
        ...
        MvcResult result = (MvcResult) mvc
            .perform(MockMvcRequestBuilders.get("/communes").accept(MediaType.APPLICATION_JSON))
            .andDo(print())
            .andExpect(status().isOk())
            .andReturn();

        ArrayList<String> listeCommunes = mapper.readValue(result.getResponse().getContentAsString(),
    ...
    public void testGetAgenceGoodID() throws Exception {
        ...
        MvcResult result = (MvcResult) mvc
            .perform(
                MockMvcRequestBuilders.get("/temps-attente/agence/{idAgence}", 4306).accept(MediaType.APPLICATION_JSON))
            .andDo(print())
            .andExpect(status().isOk())
            .andReturn();
    ...
    public void testGetAgenceBadIDNotFound() throws Exception {
        ...
        MvcResult result = (MvcResult) mvc
            .perform(
                MockMvcRequestBuilders.get("/temps-attente/agence/{idAgence}", 2).accept(MediaType.APPLICATION_JSON))
            .andDo(print())
            .andExpect(status().isNotFound())
            .andReturn();
    ...
    public void testGetAgenceBadIDBadRequest() throws Exception {
        ...
        MvcResult result = (MvcResult) mvc
            .perform(MockMvcRequestBuilders.get("/temps-attente/agence/{idAgence}", "toto")
                .accept(MediaType.APPLICATION_JSON))
            .andDo(print())
    ...
    public void testGetCsv() throws Exception {
        ...
        MvcResult result = (MvcResult) mvc
            .perform(MockMvcRequestBuilders.get("/csv").accept(MediaType.APPLICATION_JSON))
            .andDo(print())
            .andExpect(status().isOk())
            .andReturn();
